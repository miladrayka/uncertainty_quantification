...
<img src="https://github.com/miladrayka/uncertainty_quantification/blob/main/software/GUI.png" alt="drawing" width="1000" style="display: block; margin: auto;"/>

## Install

1- First install python (3.10.14) then make a virtual environment and activate it.
```
python -m venv env
...
```
3- Change your directory to *uncertainty_quantification/software*.
